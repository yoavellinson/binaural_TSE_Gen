...
import numpy as np
from losses import SiSDRLoss,PesqLoss
...
if __name__ == "__main__":
    ...
    with torch.no_grad():
        ...
        checkpoint_path = "/home/workspace/yoavellinson/binaural_TSE_Gen/checkpoints/scary-candy-2_ComplexExtraction_lr_0.0002_bs_12_loss_sisdr_L1_rev/model_epoch_best.pth"
        ...
        for step,batch in tqdm(enumerate(test_loader),total=len(test_loader)):
            ...
            sisdr_out.append(-sisdr_1)
            sisdr_in_1 = criterion_sisdr(Mix,Y1)
            sisdr_in.append(-sisdr_in_1)
            ...
            if not one_speaker:
                ...
                sisdr_out.append(-sisdr_2)
                sisdr_in_2 = criterion_sisdr(Mix,Y2)
                sisdr_in.append(-sisdr_in_2)
                sisdri.append(-sisdr_2+sisdr_in_2)
